        ...
        [
            {
                ...
                url: picture,
                time: "20 minutes",
                tags: ["These have all the elements of the perfect cookie with a soft and moist center melty morsels of chocolate and crisp edges. Best of all there's no chilling or refrigeration required so you can satisfy that cookie craving when it strikes!"],
                ingredients: ["butter", "granulated sugar", "vailla extract", "egg", "flour", "baking soda", "salt", "Chocolate Chips"],
                instructions: "1. Preheat oven to 350F. Line a baking sheet with parchment or Silpat liner. In the bowl of a stand mixer with paddle attachment. \n\n 2. combine 2 sticks of butter; 1 cup of packed brown sugar and 1/2 cup of white sugar. Beat 5 minutes on medium/high speed until creamy and light scraping down the bowl as needed.\n\n 3. Add 2 eggs; one at a time; beating well with each addition then beat in 2 tsp of vanilla.\n\n 4. In a separate bowl combine 3 cups of flour 1 tsp salt and 1 tsp of baking soda (sifted to eliminate lumps). Add the flour mixture to the creamed butter in thirds mixing to incorporate with each addition.\n\n 5. Fold in 2 cups of chocolate chips. Use an ice cream scoop to get even balls of dough (3 Tbsp each). Place scoops of dough onto lined baking sheet about 2 inches apart. Mine fit onto 3 cookie sheets and made 26 cookies. Roll balls lightly with your hands then stud tops of cookie balls with reserved chocolate chips. Bake right away or cover and refrigerate until ready to bake.; Bake one cookie sheet at a time for 12-15 min at 350˚F (we bake 12 minutes); until edges are just turning golden. The tops should still look under-baked. Allow cookies to cool on the baking sheet 5 min then transfer to a rack to cool.",
                calories: 250,
                level: "Intermediate",
            }
            //,250,20,Dessert,General,Intermediate
